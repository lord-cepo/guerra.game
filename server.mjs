...
function sandboxState(match) {
  return {
    ...
    offboardInactive: match.offboardInactive,
    namedValues: match.namedValues,
    scheduledRules: match.scheduledRules,
    ruleWork: match.ruleWork,
    paidCommand: match.paidCommand,
    turnCommand: match.turnCommand,
    pendingResolution: match.pendingResolution,
    pendingResolutionQueue: match.pendingResolutionQueue,
    dashboard: match.dashboard,
    resolutionStack: match.resolutionStack,
    currentEventId: match.currentEventId,
    normalizedEvents: match.normalizedEvents,
    ruleContributions: match.ruleContributions,
    nextRuleContributionId: match.nextRuleContributionId,
    winner: match.winner,
